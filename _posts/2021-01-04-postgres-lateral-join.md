...
We can see that both solutions have similar results, with a few milliseconds of difference between them, and we can also see that the `LATERAL` join performed better.
